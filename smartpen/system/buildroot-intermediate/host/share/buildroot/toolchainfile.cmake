...
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-linux-gnu-gcc")
set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-linux-gnu-g++")
if(0)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-linux-gnu-gfortran")
endif()
